! function(t) {
    ...
    ! function(t) {
        ...
        return t.prototype = Object.create(a.SmartSliderMainAnimationAbstract.prototype), t.prototype.constructor = t, t.prototype.changeTo = function(t, i, s, h) {
            ...
            a.MW.ft(this.slider.slides[i].SMWs, {
                zIndex: ""
            ...
            var c = a.MW.D(i.element);
            this.timeline.fromTo(c, s.inDuration, {
                opacity: 0
            }, {
                opacity: 1,
                ease: this.getEase()
            }, s.inDelay), !this._currentBackgroundAnimation && i.background && (a.MW.D(i.background.element).opacity = 1), u(this.sliderElement, "mainAnimationComplete", function(e) {
            ...
            f[c] = l, d[c] = -l, a.MW.ft(n, {
                zIndex: 23
            });
            var m = {
                zIndex: 23
            };
            m[c] = l, a.MW.ft(o, m), t.unsetActive(), i.setActive();
            ...
            if (this.timeline.to(n, S.outDuration, d, S.outDelay), this.isTouch && this.isReverseAllowed)
                if (h ? this.slider.blockCarousel && this.slider.isChangeCarousel("next") || (p = t.getNext()) : this.slider.blockCarousel && this.slider.isChangeCarousel("previous") || (p = t.getPrevious()), p && p !== i) {
                    ...
                    I[c] = 0, A[c] = -l, C[c] = l, w[c] = 0, p.l("mainAnimationStartIn", {
                        mainAnimation: this,
        ...
        function t() {
            this.round = 1, a.SmartSliderResponsive.prototype.constructor.apply(this, arguments), this.ui = this.sliderElement.classList.contains("n2-ss-full-page--constrain-ratio"), this.mainAnimation = this.slider.mainAnimation
        }
        return t.prototype = Object.create(a.SmartSliderResponsive.prototype), t.prototype.constructor = t, t.prototype.init = function() {
            ...
            if (this.resizeContext.slideOuterWidth = n.width, this.resizeContext.slideOuterHeight = n.height, a.SmartSliderResponsive.prototype.calculateResponsiveValues.call(this), this.ui) {
                ...
                a.MW.D(this._cacheEl.slider)["--ss-clip-path"] = "inset(" + r + " " + o + " " + r + " " + o + ")"
            }
        }, t.prototype.onStarterSlide = function(t) {
            this.slider.slides.forEach((function(t) {
                t.SMWs = [a.MW.D(t.element, {
                    x: "-10000px"
                })], t.background && t.SMWs.push(a.MW.D(t.background.element, {
                    x: "-10000px"
                }))
