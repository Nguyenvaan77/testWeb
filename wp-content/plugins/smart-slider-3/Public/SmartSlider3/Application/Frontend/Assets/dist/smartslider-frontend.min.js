! function(t) {
    ...
    var s, n, h = t.document,
        ...
        N = navigator.userAgent.indexOf("+http://www.google.com/bot.html") > -1 ? function(t) {
            t()
    ...
    j((function() {
        ...
        return t.prototype.preLoad = function(t) {
            ...
            if (this.slider.stages.resolved("Visible"))
                for (var o = 0; o < i.length; o++) this.slider.i.addPromise(i[o]);
            return i
        }, t
    })), Y("litespeed-optm-css-rules"), Y("rocket-critical-css"), u.d("SmartSliderLoad", (function() {
        ...
        return s.prototype.start = function() {
            ...
            this.slider.stages.resolve("BeforeShow"), this.slider.widgets.onReady(), u.MW.h(function() {
                A(this.slider.responsive.alignElement, "n2-ss-align-visible"), A(this.slider.sliderElement, "n2-ss-loaded"), I(this.slider.sliderElement, "n2notransition"), requestAnimationFrame((function() {
                    F(i, "scroll")
                })), N(this.slider.startVisibilityCheck.bind(this.slider), {
                    timeout: 2e3
                })
        ...
        return t.prototype.onSliderExists = function(t, s, n) {
            if (this.__sliderElement = n, this.o = n.closest(".n2-section-smartslider"), this.i = this.o.querySelector("ss3-loader"), this.stages.resolve("Exists"), "TEMPLATE" === n.tagName) {
                var h = n.parentNode;
                h.removeChild(n);
                var o = m(n, "loadingType"),
                    a = n.content.children[0],
                    c = function() {
                        h.appendChild(a), k(this.o, "height"), this.waitForDimension(a, s), D(i, "n2Rocket", {
                            sliderElement: a
                        })
                    }.bind(this);
                "afterOnLoad" === o ? u.r("windowLoad", l.bind(this, this.o, c)) : "afterDelay" === o ? r(c, m(n, "loadingDelay")) : c()
            ...
            if (new u.UniversalEnter(this.sliderElement, function(e) {
                ...
                this.load.start(), O(this.sliderElement, "keydown", (function(t) {
                    "Space" !== t.code && "Enter" !== t.code && "NumpadEnter" !== t.code || t.target.matches('[role="button"],[tabindex]') && t.target.matches(":not(a,input,select,textarea)") && (t.preventDefault(), t.target.click(), R(t.target, "n2Activate"))
            ...
            this.afterRawSlidesReady(), this.stages.resolve("RawSlides"), this.randomize(this.realSlides), this.stages.resolve("RawSlidesOrdered"), this.u()
        ...
        }, t.prototype.afterRawSlidesReady = function() {}, t.prototype.l = function(t, i) {
            D(this.sliderElement, t, i)
        }, t.prototype.publicDispatchEvent = function(t, i) {
            this.l(t, i), u.SmartSliderApi.dispatch(t, this)
            ...
            if (this.isAdmin) this.finalizeStarterSlideComplete(t);
                ...
                if (i["ss" + this.id] !== n) "object" == typeof i["ss" + this.id] ? i["ss" + this.id].done(this.overrideStarterSlideIndex.bind(this)) : this.overrideStarterSlideIndex(i["ss" + this.id]);
                else if (this.parameters.maintainSession && i.localStorage !== n) {
                    var s = i.localStorage.getItem("ss-" + this.id);
                    this.overrideStarterSlideIndex(s)
                } else this.finalizeStarterSlideComplete(t);
                this.parameters.maintainSession && i.localStorage !== n && O(this.sliderElement, "mainAnimationComplete", function(e) {
            ...
            if (!this.isAdmin && this.parameters.playWhenVisible && i.IntersectionObserver) {
                ...
                o.observe(this.sliderElement), this.v = [h.disconnect.bind(h), o.disconnect.bind(o), L(this.sliderElement, "pointerover", this._markVisible.bind(this))]
            } else this.stages.resolve("Visible")
        }, t.prototype._markVisible = function() {
            this.v && z(this.v), this.stages.resolve("Visible")
            ...
            this.setCurrentRealSlide(this.slides[t]), this.l("sliderChangeCurrentSlide")
        }, t.prototype._changeTo = function(t, i, s, n) {}, t.prototype.revertTo = function(t, i) {
            this.slides[i].unsetActive(), this.slides[t].setActive(), this._changeCurrentSlide(t), this.l("SlideWillChange", {
                targetSlide: this.slides[t]
            })
        ...
        function t(t, i) {
            this.state = "ended", this.isTouch = !1, this.isReverseAllowed = !0, this.isReverseEnabled = !1, this.reverseSlideIndex = null, this.isNoAnimation = !1, this.slider = t, this.parameters = f({
                duration: 1500,
                ease: "easeInOutQuint"
            }, i), this.parameters.duration = Math.max(.01, this.parameters.duration / 1e3), this.sliderElement = t.sliderElement, this.timeline = new u.p({
                paused: !0
        ...
        return t.prototype.init = function() {
            ...
            this.isReverseEnabled = !0, this.reverseTimeline = new u.p({
                paused: !0
            ...
            this.slider.l("mainAnimationStart", n), t.l("mainAnimationStartOut", n), i.l("mainAnimationStartIn", n)
            ...
            this.clearTimelines(), this.disableReverseMode(), t.l("mainAnimationCompleteOut", n), i.l("mainAnimationCompleteIn", n), this.state = "ended", this.slider.updateInsideSlides([i]), s || i.focus(), this.slider.l("mainAnimationComplete", n)
        ...
        function t(t, s) {
            this.m = t, this.S = t.sliderElement, this.g = t.o, this.k = m(this.g, "alias"), this.C = f({
                id: 0,
                smoothScroll: 0,
                slideSwitch: 0,
                scroll: 1
            }, s), this.k && (this.C.smoothScroll && y(o, "scroll-behavior", "smooth"), this.C.slideSwitch && (this.switchOnLoad(), O(i, "hashchange", function() {
                var t = this.getAnchor();
                t && Number.isInteger(t) && t > 0 && (1 === this.m.responsive.parameters.focusUser ? (this.m.responsive.parameters.focusUser = 0, this.switchToSlide(t - 1), this.m.responsive.parameters.focusUser = 1) : this.switchToSlide(t - 1), this.replaceHash())
            }.bind(this))))
        }
        return t.prototype.getAnchor = function() {
            var t = i.location.hash.substr(1);
            if (t) {
                if (t === this.k) return !0;
                if (this.C.slideSwitch && 0 === t.indexOf(this.k)) {
                    var s = +t.substr(this.k.length + 1);
                    if (s > 0) return s
                }
            }
            return !1
            ...
            if (t && Number.isInteger(t) && t > 0) {
                ...
                }.bind(this)) : i["ss" + this.m.id] = s, this.m.parameters.maintainSession && i.localStorage !== n && s <= this.m.visibleSlides.length && i.localStorage.setItem("ss-" + this.m.id, s), this.replaceHash()
            }
        ...
        return t.prototype.preventClickHandle = function() {
            ...
            this._listeners.push(L(t, "SlideLoading", function() {
                ...
                this.timeline.duration(this.getSlideDuration(e.detail.currentSlideIndex)), this.A = !0, this.timeline.pause(0, !1), this.setState("mainAnimationPlaying", 0)
                ...
                this.timeline.duration(this.getSlideDuration(e.detail.currentSlide.index)), this.A = !0, this.timeline.pause(0, !1), this.setState("mainAnimationPlaying", 0)
            ...
            this.timeline && this.timeline.eventCallback("onUpdate", function() {
                this.slider.l("autoplay", {
                    progress: this.timeline.progress()
                })
            }.bind(this))
        }, t.prototype.next = function() {
            if (this.A) {
                if (this.A = !1, this.timeline.pause(), !this.parameters.autoplayLoop) {
        ...
        function t(i, s, n) {
            this.slider = i, this.responsive = this.slider.responsive, this._type = this.responsive.parameters.type, this._upscale = this.responsive.parameters.upscale, this.I = !1, this.S = this.slider.sliderElement, this.M = this.S.closest(".n2-section-smartslider"), O(h, t.event, this.fullScreenChange.bind(this))
        }
        return t.isSupported = !(!h.exitFullscreen && !h.webkitExitFullscreen), t.isSupported && (t.requestFullscreen = o.requestFullscreen || o.webkitRequestFullscreen, t.exitFullscreen = h.exitFullscreen || h.webkitExitFullscreen, t.event = o.requestFullscreen ? "fullscreenchange" : o.webkitRequestFullscreen ? "webkitfullscreenchange" : null), t.prototype.switchState = function() {
            this.I = !this.I, this.I ? this._fullScreen() : this._normalScreen()
        }, t.prototype.requestFullscreen = function() {
            return !this.I && (this.I = !0, this._fullScreen(), !0)
        }, t.prototype.exitFullscreen = function() {
            return !!this.I && (this.I = !1, this._normalScreen(), !0)
        }, t.prototype._fullScreen = function() {
            this.responsive.I = !0, this.responsive.parameters.type = "fullpage", this.S.dataset.responsive = this.responsive.parameters.type, this.responsive.parameters.upscale = !0, this._marginLeft = this.responsive.containerElement.style.marginLeft, this._marginRight = this.responsive.containerElement.style.marginRight, g(this.responsive.containerElement, {
                marginLeft: 0,
                marginRight: 0
            }), g(this.M, {
                width: "100%",
            ...
            this.isDocumentInFullScreenMode() ? (this.slider.l("n2FullScreen"), A(o, "n2-in-fullscreen"), A(this.slider.sliderElement, "n2-ss-slider--fullscreen"), this.I = !0, "auto" === this._type && y(this.slider.responsive.alignElement, "max-width", "none"), F(i, "resize")) : (this.responsive.I = !1, this.responsive.parameters.type = this._type, this.S.dataset.responsive = this._type, this.responsive.parameters.upscale = this._upscale, g(this.responsive.containerElement, {
                ...
                height: "",
                "background-color": ""
            }), I(this.slider.sliderElement, "n2-ss-slider--fullscreen"), I(o, "n2-in-fullscreen"), "auto" === this._type && k(this.slider.responsive.alignElement, "max-width"), F(i, "resize"), this.I = !1, this.slider.l("n2ExitFullScreen"))
        ...
        function t(t, i) {
            this.preventScroll = {
                ...
                globalTimeout: !1
            }, this.maxDelta = 0, this.slider = t, this.F = 2 === i ? "deltaX" : "deltaY", h.addEventListener("wheel", this.onGlobalMouseWheel.bind(this), {
                passive: !1
        ...
        return t.prototype.hasScrollableParentVertical = function(t, s) {
            ...
            e.target.closest(".n2-ss-slider") && 0 !== e[this.F] && (this.onCurveEvent(e), this.preventScroll.local || this.preventScroll.curve || Math.abs(e[this.F]) < this.maxDelta / 2 ? e.preventDefault() : (this.preventScroll.global && e.preventDefault(), (this.slider.sliderElement === e.target || this.slider.sliderElement.contains(e.target)) && ("deltaY" === this.F ? e.shiftKey || this.hasScrollableParentVertical(e.deltaY < 0, e.target) || this.onMouseWheel(e) : "deltaX" === this.F && (this.hasScrollableParentHorizontal(e.target) || this.onMouseWheel(e)))))
        }, t.prototype.onMouseWheel = function(e) {
            e[this.F] < 0 ? this.slider.isChangeCarousel("previous") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.previous(), e.preventDefault(), this.startCurveWatcher(e), this.local(), this.global()) : e[this.F] > 0 && (this.slider.isChangeCarousel("next") && this.slider.parameters.controls.blockCarouselInteraction || (this.slider.next(), e.preventDefault(), this.startCurveWatcher(e), this.local(), this.global()))
        }, t.prototype.startCurveWatcher = function(e) {
            !1 !== this.preventScroll.curve && a(this.preventScroll.curveTimeout), this.preventScroll.curveGlobal || (this.dynamicDelta = !1, this.lastDelta = e[this.F], this.preventScroll.curveGlobal = !0, this.preventScroll.curveGlobalTimeout = r(function() {
            ...
            if (this.preventScroll.curveGlobal) {
                this.dynamicDelta || this.lastDelta === e[this.F] || (this.lastDelta = e[this.F], this.dynamicDelta = !0);
                var t = Math.abs(e[this.F]);
        ...
        return t.prototype.onStarterSlide = function() {
            ...
            "vertical" === this.axis && (this.slider.controlFullscreen && this.slider.controlFullscreen.I || (this.currentInteraction.action = "scroll", "pointer" === this.currentInteraction.type && (y(o, "scroll-behavior", "auto"), V(Math.max(0, this.currentInteraction.scrollTop - t)))))
        ...
        return t.prototype.getLoadPromise = function() {
            ...
            u.P.to(u.MW.R(this.imageElements), .3, {
                opacity: 0
            })
        }, t.prototype.onSlideDeviceChanged = function() {}, t
        ...
        return t.prototype = Object.create(u.FrontendComponent.prototype), t.prototype.constructor = t, t.prototype.init = function(t) {
            ...
            t && (u.MW.D(this.layer).layerRotation = t)
        ...
        return t.prototype.start = function() {}, t.prototype.onDeviceChange = function(t) {}, t.prototype.L = function() {
        ...
        function t(t, i, s) {
            ...
            ("0" === n || +n > 0) && this.focusableElements.push(i), this.disableFocus(), this.background = !1, t.parameters.admin ? this.minimumSlideDuration = 0 : (this.minimumSlideDuration = +m(i, "slideDuration"), this.minimumSlideDuration || (this.minimumSlideDuration = 0)), this._isCurrentlyEdited = this.slider.parameters.admin && i.classList.contains("n2-ss-currently-edited-slide"), this.isCurrentlyEdited() ? (this.layer = i.querySelector('.n2-ss-layer[data-sstype="slide"]'), O(t.sliderElement, "SliderDeviceOrientation", function() {
                this.slider.visibleRealSlides.push(this), this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.l("Visible")
        ...
        return t.prototype.focus = function() {
            ...
            m(this.element, "hide" + H(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.slider.responsive.visibleRealSlidesChanged = !0, this.l("Hidden")) : (this.slider.visibleRealSlides.push(this), !0 !== this.isVisible && (this.isVisible = !0, this.slider.responsive.visibleRealSlidesChanged = !0, this.l("Visible")))
        ...
        return t.prototype.isStatic = function() {
            ...
            m(this.element, "hide" + H(t)) ? !1 !== this.isVisible && (this.isVisible = !1, this.l("Hidden")) : !0 !== this.isVisible && (this.isVisible = !0, this.status.is("INITIALIZED") && this.playIn(), this.l("Visible"))
        }, t
    })), u.d("FrontendPlacementAbsolute", ["FrontendPlacement"], (function() {
        var t = new class {
            constructor() {
                this.O = new Set, this.T = new Set, this._ = this.V.bind(this)
            }
            add(t) {
                this.O.add(t)
            }
            invalidate(t) {
                this.T.add(t), 1 === this.T.size && u.B.add(this._)
            }
            V() {
                for (let t of this.T) t.L();
                for (let t of this.T) t.onResizeSize();
                for (let t of this.T) t.onResizePosition();
                this.T.clear(), u.B.remove(this._)
            }
        };
        ...
        return i.prototype = Object.create(u.FrontendPlacement.prototype), i.prototype.constructor = i, i.prototype.start = function() {
            ...
            u.FrontendPlacement.prototype.L.apply(this, arguments);
            ...
            if (this.parentLayerPlacement && this.parentLayerPlacement.isVisible()) {
                ...
                if (this.parentLayerPlacement instanceof u.FrontendPlacementAbsolute) {
                    var d = u.MW.D(this.parentLayerPlacement.layer.layer);
                ...
                switch (a) {
                    case "right":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.H.slideWidth : this.j.width, s.xAbs = Math.round(v + o), s.xPAbs = -100;
                        break;
                    case "center":
                        v = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.H.slideWidth : this.j.width, s.xAbs = Math.round(v / 2 + o), s.xPAbs = -50;
                        break;
                    default:
                ...
                switch (c) {
                    case "bottom":
                        p = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.H.slideHeight : this.j.height, s.yAbs = Math.round(p + r), s.yPAbs = -100;
                        break;
                    case "middle":
                        p = !this.layer.slide.isStatic && this.layer.parent instanceof u.FrontendComponentSectionSlide ? this.H.slideHeight : this.j.height, s.yAbs = Math.round(p / 2 + r), s.yPAbs = -50;
                        break;
                    default:
            ...
            this.isVisible() && (this.W = i, this.H = s, t.invalidate(this), u.FrontendPlacement.prototype.onResize.apply(this, arguments))
        ...
        function l(t, s) {
            for (var n in this.state = {
                    StarterSlide: !1
                }, this.isVisible = !0, this.isResetActiveSlideEarly = this.isResetActiveSlideEarly || !1, this.focusOffsetTop = 0, this.focusOffsetBottom = 0, this.minimumSlideHeight = 0, this.I = !1, this.visibleRealSlidesChanged = !0, this.N = -1, this.Y = -1, this.q = -1, this.U = -1, this.filters = {
                    SliderWidth: [],
                    SliderHeight: [],
                    SlideHeight: [],
                    SliderVerticalCSS: []
            ...
            this.parameters.hideOn = i.ssOverrideHideOn || this.parameters.hideOn, this.doThrottledResize = NextendThrottle(this.doResize.bind(this), 50), this.slider = t, this.sliderElement = t.sliderElement, this.G = "1" === m(this.sliderElement, "ssLegacyFontScale"), this.addFilter("SliderWidth", this.filterSliderWidthHorizontalSpacing.bind(this))
        }
        return h.addEventListener("scroll", (function() {
            ...
            if (this.slider.stages.done("ResizeFirst", function() {
                    ...
                    paddingBottom: 0,
                    paddingLeft: 0
                }, this.alignElement = this.slider.sliderElement.closest(".n2-ss-align"), this.o = this.slider.o, this.containerElementPadding = this.sliderElement.parentNode, this.containerElement = this.containerElementPadding.parentNode, !this.slider.isAdmin && this.parameters.overflowHiddenPage && C([o, s], "overflow", "hidden"), u._smallestZoom = 320, this.initFocusOffsetObserver(), this.slider.stages.resolve("ResponsiveStart"), this.init(), this.parameters.onResizeEnabled) {
            ...
            this.N = i.innerWidth, this.Y = i.innerHeight, this.slider.mainAnimation && "playing" === this.slider.mainAnimation.getState() ? this.K || (this.K = !0, T(this.sliderElement, "mainAnimationComplete", this._onResize.bind(this, e))) : this._onResize(e)
        }, l.prototype._onResize = function(e) {
            this.doResize(e), delete this.K
            ...
            if (!this.slider.isAdmin && c && this.q === this.N) {
                const t = Math.abs(this.U - this.Y);
                if (t > 0 && t < 100) return
            }
            this.q = this.N, this.U = this.Y;
            var t = this.identifyDeviceID();
            if (this.parameters.hideOn[l._DeviceMode[t]]) return A(this.o, "n2-section-smartslider--hidden"), !1;
            if (I(this.o, "n2-section-smartslider--hidden"), !this.isVisible) return !1;
            var i = !1,
                s = this.device;
            if (this.deviceID !== t && (this.setDeviceID(t), s && I(this.sliderElement, "n2-ss-" + s), b(this.sliderElement, "deviceMode", this.device), A(this.sliderElement, "n2-ss-" + this.device), this.slider.l("SliderDevice", {
                    lastDevice: s,
                    device: this.device,
                    ...
                    device: this.device,
                    group: l._DeviceGroup[this.device]
                }), this.slider.stages.resolve("DeviceOrientation"), this.finalizeVisibleSlidesStage1()), !this.slider.visibleRealSlides.length) return this.parameters.hideOn[l._DeviceMode[t]] = !0, A(this.o, "n2-section-smartslider--hidden"), !1;
            if (this.slider.isVisible || this.visibleRealSlidesChanged) {
                for (var n = 0; n < this.slider.realSlides.length; n++) u.MW.D(this.slider.realSlides[n].element).setValues({
                    width: "",
                    height: ""
                ...
                this.resizeStage1Width(), this.slider.l("SliderResizeHorizontal"), this.resizeStage2Height()
            }
            ...
            }, this.G && C(this.sliderElement.querySelectorAll('.n2-ss-layer[data-sstype="slide"] > .n2-ss-layer[data-pm="absolute"][data-adaptivefont="0"]'), "font-size", "calc(" + 16 * this.ratios.slideW + "px * var(--ssfont-scale, 1))");
            for (var t = 0; t < this.slider.realSlides.length; t++) u.MW.D(this.slider.realSlides[t].element).setValues({
            ...
            })), this.updateVisibleSlides(), this.slider.l("visibleRealSlidesChanged"), this.slider.stages.resolve("VisibleRealSlides"), this.isResetActiveSlideEarly && this.calibrateActiveSlide())
            ...
            var i, s;
            t && t !== this.slider.currentRealSlide ? (this.slider.l("BeforeCurrentSlideChange", t), (i = this.slider.currentSlide) && this.slider.forceUnsetActiveSlide(i), this.slider.setCurrentRealSlide(t), s = this.slider.currentSlide, this.targetCurrentSlide = s, this.slider.forceSetActiveSlide(s), this.slider.l("SlideForceChange", {
                oldSlide: i,
                currentSlide: s
            })) : s = this.slider.currentSlide, this.slider.updateInsideSlides([s])
        }, l.prototype.finalizeVisibleSlidesStage2 = function() {
            this.visibleRealSlidesChanged && (this.visibleRealSlidesChanged = !1, this.isResetActiveSlideEarly || this.calibrateActiveSlide(), this.triggerVisibleSlidesChanged(), this.targetCurrentSlide !== n && (this.slider.l("SlideWillChange", {
                targetSlide: this.targetCurrentSlide
            }), this.slider.l("CurrentSlideChanged", {
            ...
            this.slider.l("visibleSlidesChanged"), this.slider.stages.resolve("VisibleSlides"), this.slider.visibleRealSlides.length ? this.slider.isVisible || this.slider.show() : this.slider.isVisible && this.slider.hide()
            ...
            return this.I ? 0 : this.slider.widgets.getVerticalsHeight()
        ...
        return t.prototype.whenLoaded = function() {
            ...
            this.coverFadedOut === n && this.cover && (this.coverFadedOut = !0, u.P.to(u.MW.D(this.cover), .3, {
                opacity: 0,
                onComplete: function() {
                    x(this.cover)
                }.bind(this)
