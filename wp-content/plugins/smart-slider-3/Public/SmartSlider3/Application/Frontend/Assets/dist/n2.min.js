! function(t) {
    ...
    x((function() {
        ...
        function() {
            ...
            var n, r = new class {
                    constructor() {
                        this.t = !1, this.X = new Set, this._ = this.V.bind(this)
                    }
                    add(t) {
                        this.X.add(t), this.t || (this.t = !0, u.B.add(this._))
                    }
                    V() {
                        for (let t of this.X) t.render ? t.render() : t();
                        this.X.clear(), this.t = !1, u.B.remove(this._)
                    }
                },
                o = {};
            ...
            class h {
                constructor(i, n) {
                    t(i) ? this.J = Array.from(i) : this.J = [i], this.tt = f({}, n), this.it = new Set
                }
                get scale() {
                    return this.scaleX
                }
                    ...
                    for (let i of this.it) {
                        ...
                        switch (i) {
                            ...
                            case "filter":
                                ...
                                break;
                            case "n2AutoAlpha":
                                0 === this.opacity ? this.st || (this.st = !0, this.rt("data-force-hidden", "")) : this.st && (this.st = !1, this.ot("data-force-hidden"));
                                continue;
                            case "opacity":
                                this.tt.n2AutoAlpha && (0 === t ? this.st || (this.st = !0, this.rt("data-force-hidden", "")) : this.st && (this.st = !1, this.ot("data-force-hidden")));
                                break;
                            case "width":
                            case "height":
                            case "perspective":
                        ...
                        for (let n of this.J) n.style.setProperty(i, t)
                    }
                    this.it.clear()
                }
                nt() {
                ...
                rt(t, i) {
                    for (let n of this.J)(n.relatedLayer || n).setAttribute(t, i)
                }
                ot(t) {
                    for (let i of this.J)(i.relatedLayer || i).removeAttribute(t)
                }
                setValues(t) {
            ...
            class a {
                constructor(t, i) {
                    this.ht = [];
                    for (var n = 0; n < t.length; n++) t[n] && this.ht.push(b.D(t[n], i))
                }
                setValues(t) {
                    for (var i = 0; i < this.ht.length; i++) this.ht[i].setValues(t)
                }
            }
            var c = {},
                l = function(t) {
                    Object.defineProperty(a.prototype, t, {
                        ...
                        set: function(i) {
                            ...
                            for (var n = 0; n < this.ht.length; n++) this.ht[n][t] = i
                        }
                    })
                },
                v = function(t, i, n) {
                    Object.getOwnPropertyDescriptor(h.prototype, t) || (i === s && (i = ""), n === s && (n = t), c[n] === s && (c[n] = []), c[n].push(t), o[t] = i, Object.defineProperty(h.prototype, t, {
                        get: function() {
                            return this.tt[t] === s && (this.tt[t] = o[t]), this.tt[t]
                        },
                        set: function(i) {
                            i instanceof Function && (i = i()), this.tt[t] !== i && (this.tt[t] = i, this.it.add(n), r.add(this))
                        }
                    }), l(t))
                },
                d = function(t, i) {
            ...
            class g {
                constructor(i) {
                    t(i) ? this.J = Array.from(i) : this.J = [i], this.at = []
                }
                addClass(t) {
                    this.at.push([0, t]), r.add(this)
                }
                removeClass(t) {
                    this.at.push([1, t]), r.add(this)
                }
                render() {
                    for (var t = 0; t < this.at.length; t++) {
                        var i = this.at[t];
                        for (let t of this.J) m[i[0]].apply(t, i.splice(1))
                    }
                    this.at = []
                }
            }
            var b = u.MW = {
                ...
                R: function(t, i) {
                    for (var n = [], s = 0; s < t.length; s++) n.push(b.D(t[s], i));
                    return n
                },
                ct: function(t, i) {
                    return new a(t, i)
            ...
            connectedCallback() {
                if (this.isConnected) {
                    n = n || r.body, this.bt = "rtl" === o.getAttribute("dir"), this._width = 0, this._offset = Number.MAX_SAFE_INTEGER, this.wt = u.MW.D(this, {
                        x: Number.MAX_SAFE_INTEGER,
                        opacity: 0
                    });
                    var t = d(this, "overflowX");
                    t && "none" !== t && r.querySelectorAll(t).forEach((function(t) {
                        u.MW.D(t).overflowX = "hidden"
                    }));
                    var s = n;
            ...
            doResize() {
                ...
                if (this.fullWidthTo) {
                    ...
                    s = r.width, t = this.bt ? -s + r.right : r.left
                }
                var o, h, a = s > 0 ? s : n.clientWidth,
                    u = i.getComputedStyle(this.parentNode);
                o = this.bt ? a - this.parentNode.getBoundingClientRect().right - parseInt(u.getPropertyValue("padding-right")) - parseInt(u.getPropertyValue("border-right-width")) + t : -this.parentNode.getBoundingClientRect().left - parseInt(u.getPropertyValue("padding-left")) - parseInt(u.getPropertyValue("border-left-width")) + t, o += h = o % 1, a -= Math.floor(h), (this._width - a <= 0 || this._width - a > 1 || this._offset - o < -1 || this._offset - o >= 0) && (this._offset !== o && (this.wt.x = o, this._offset = o, 0 !== o && this.classList.add("n2-ss-no-bga-fixed")), this._width !== a && (this.wt.width = a, this._width = a)), this.setVisible && this.setVisible()
            }
            setVisible() {
                this.wt.opacity = 1, delete this.setVisible
            }
            ...
            set display(t) {
                this.Mt !== t && (this.Mt = t, this.style.display = t)
            }
            show() {
                this.display = "grid"
            }
            addPromise(t) {
                this.yt.push(t), this.syncStyle(), t.finally(this.removePromise.bind(this, t))
            }
            removePromise(t) {
                var i = this.yt.indexOf(t);
                i > -1 && (this.yt.splice(i, 1), this.syncStyle())
            }
            syncStyle() {
                this.yt.length ? this.xt || (this.xt = h(this.show.bind(this), 100)) : (this.xt && (a(this.xt), delete this.xt), this.display = "")
            }
        });
    ...
    i.n2const = {
        ...
        function() {
            ...
            return t.prototype.initParameters = function() {
                ...
                this._isReversed ? (this._progress -= t / this._duration * this._timeScale, 1 != i && this._isStarted ? this._progress <= 0 ? (this._progress = 0, this._isPlaying = !1, u.B.removeP(this.getTickCallback()), this._onUpdate(), this._onReverseComplete()) : this._onUpdate() : this._onReverseStart()) : (this._progress += t / this._duration * this._timeScale, 0 != i && this._isStarted ? this._progress >= 1 ? (this._progress = 1, this._isPlaying = !1, u.B.removeP(this.getTickCallback()), this._onUpdate(), this._onComplete()) : this._onUpdate() : this._onStart())
                ...
                return this._isPlaying = !1, u.B.removeP(this.getTickCallback()), arguments.length > 0 && null != arguments[0] && this.progress(this._timeToProgress(arguments[0])), this
                ...
                this._clearDelayTimeout(), this._isPlaying || (u.B.addP(this.getTickCallback()), this._isPlaying = !0)
            ...
            return t.prototype = Object.create(u.Animation.prototype), t.prototype.constructor = t, t.prototype._onUpdate = function() {
                ...
                this.addTween(u.P.to(t, .05, i), n)
            }, t.prototype.to = function(t, i, n, s) {
                n.paused = !0, this.addTween(u.P.to(t, i, n), s)
            }, t.prototype.fromTo = function(t, i, n, s, r) {
                s.paused = !0, this.addTween(u.P.fromTo(t, i, n, s), r)
